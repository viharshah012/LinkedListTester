...
//		}
		...
		//
		NUM_TESTS = 25000000;
		//size = 100,000 for insertAt
		//size = 25,000 for find
...
//		insertAt
//		int t1 = (int) System.currentTimeMillis();
//		for(int i=0; i<NUM_TESTS/250; i++) {
//			TestList.insertAt(12000, 5);
//		}
//		int time = (int)System . currentTimeMillis () - t1 ;
//		System.out.println(time);
